...
*Analog Circuit Simulation QA Intern @ Siemens DISW | GP @ Pearl Semiconductor | Junior Electronics and Communication Systems Engineering Student ASU ’27 | ASU Racing Team | USAID Scholar*

I am an Electronics and Communication Engineering student at Ain Shams University with a strong passion for analog/mixed-signal IC design, physical verification, and EDA automation. I love combining classical circuit design with modern scripting and agentic AI workflows to build efficient, automated EDA solutions.

## 🛠️ Skills & Technologies
- **IC Design & Layout:** Analog IC Design, Mixed-Signal (PLLs, SerDes), Full-Custom Layout, Physical Verification (DRC/LVS/PEX)
- **EDA Tools:** Cadence Virtuoso, Siemens EDA (Solido SPICE, Eldo, AFS, Calibre), Silvaco TCAD, Ngspice, QuestaSim
- **Programming & Scripting:** Python, C/C++, MATLAB, Shell (Bash), TCL
- **Hardware Description:** Verilog, Verilog-A
...
- **Email:** [ahmed0sherif9@gmail.com](mailto:ahmed0sherif9@gmail.com)
